...
const USER_TABLE='"MyPrep users"';
const SESSION_TABLE='"MyPrep sessions"';
...
app.use(express.static(path.join(__dirname)));app.listen(PORT,"0.0.0.0",()=>console.log(`MyPrep running on port ${PORT}`));